            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-lg-5">
                        <li class="nav-item">
                            <a class="nav-link" href="#section_2">Комментарий</a>
                        </li>
                    </ul>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-8 col-12 mx-auto">
                            <h3 class="mb-4 text-center">Отзыв</h3>

                            <form action="process_comment.php" method="post">
                                <label class="mb-2" for="username">Ваше имя:</label>
                                <input class="form-control" type="text" name="username" required><br>

                                <label class="mb-2" for="comment">Комментарий:</label>
                                <textarea class="form-control" name="comment" rows="4" required></textarea><br>

                                <button type="submit" class="form-control custom-btn btn btn-lg">Отправить комментарий</button>
                            </form>
